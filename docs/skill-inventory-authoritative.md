...
- software-development/verification-before-completion | source=local | status=enabled | use_count=250 | size_bytes=20593
- autonomous-ai-agents/hermes-agent | source=builtin | status=enabled | use_count=196 | size_bytes=49728
...
- software-development/local-personal-dashboard | source=local | status=enabled | use_count=43 | size_bytes=34881
...
- autonomous-ai-agents/hermes-performance-tuning | source=local | status=enabled | use_count=21 | size_bytes=20114
...
- superpowers/writing-skills | source=local | status=enabled | use_count=15 | size_bytes=4793
...
- research/research-paper-writing | source=builtin | status=disabled | size_bytes=104329 | use_count=0
- autonomous-ai-agents/hermes-agent | source=builtin | status=enabled | size_bytes=49728 | use_count=196
- software-development/local-personal-dashboard | source=local | status=enabled | size_bytes=34881 | use_count=43
...
- autonomous-ai-agents/ouroboros/seed | source=local | status=enabled | size_bytes=29798 | use_count=1
...
- software-development/verification-before-completion | source=local | status=enabled | size_bytes=20593 | use_count=250
- research/llm-wiki | source=builtin | status=disabled | size_bytes=20129 | use_count=0
- autonomous-ai-agents/hermes-performance-tuning | source=local | status=enabled | size_bytes=20114 | use_count=21
...
- fedora-atomic-system-maintenance | status=unknown_or_historical | replacement=None | use_count=4
- fedora-atomic-system-updates | status=unknown_or_historical | replacement=None | use_count=11
- github-auth | status=unknown_or_historical | replacement=None | use_count=1
- github-code-review | status=unknown_or_historical | replacement=None | use_count=12
- github-pr-followup-automation | status=unknown_or_historical | replacement=None | use_count=4
- github-pr-workflow | status=unknown_or_historical | replacement=None | use_count=8
- github-repo-management | status=unknown_or_historical | replacement=None | use_count=9
- github:github-pr-followup-automation | status=unknown_or_historical | replacement=None | use_count=1
- hermes-live-research-setup | status=unknown_or_historical | replacement=None | use_count=9
- hermes-security-preflight | status=unknown_or_historical | replacement=None | use_count=29
- hermes-stack-maintenance | status=unknown_or_historical | replacement=None | use_count=18
...
- low-friction-repo-hardening | status=unknown_or_historical | replacement=None | use_count=4
...
- signal-oriented-research-briefing | status=unknown_or_historical | replacement=None | use_count=18
- silverblue-desktop-ricing-adaptation | status=unknown_or_historical | replacement=None | use_count=89
- silverblue-update-automation | status=unknown_or_historical | replacement=None | use_count=22
- software-supply-chain-scanning | status=unknown_or_historical | replacement=None | use_count=5
- wallust-desktop-theme-integration | status=unknown_or_historical | replacement=None | use_count=7
- waybar-popup-menu-debugging | status=unknown_or_historical | replacement=None | use_count=8
- wayland-session-troubleshooting | status=unknown_or_historical | replacement=None | use_count=44
