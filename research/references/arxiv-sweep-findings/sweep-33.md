...
- **2609.09133** ExecCritic — test-based feedback for coding agents (`hermes-coding-review-loop`). Already partially absorbed in `harness-first-agent-design` references (frozen tests + separate repair). Remaining: role-separated Test vs Repair in the coding-review loop itself.
