...
- software-development/verification-before-completion | source=local | status=enabled | use_count=251 | size_bytes=20668
- autonomous-ai-agents/hermes-obsidian-sync | source=local | status=enabled | use_count=251 | size_bytes=15516
- autonomous-ai-agents/hermes-agent | source=builtin | status=enabled | use_count=198 | size_bytes=49826
- devops/fedora-atomic-dotfiles-adaptation | source=local | status=enabled | use_count=114 | size_bytes=8850
- github/github-operations | source=local | status=enabled | use_count=59 | size_bytes=10857
...
- autonomous-ai-agents/hermes-runtime-maintenance | source=local | status=enabled | use_count=44 | size_bytes=10425
...
- devops/atomic-desktop-app-installation | source=local | status=enabled | use_count=40 | size_bytes=8937
- research/recent-news-briefing | source=local | status=enabled | use_count=39 | size_bytes=9764
- software-development/security-hardening-balance-review | source=local | status=enabled | use_count=38 | size_bytes=4191
- research/research-briefing | source=local | status=enabled | use_count=36 | size_bytes=10288
- software-development/subagent-driven-development | source=local | status=enabled | use_count=29 | size_bytes=6675
- research/last30days-customization | source=local | status=enabled | use_count=28 | size_bytes=7781
...
- autonomous-ai-agents/hermes-agent | source=builtin | status=enabled | size_bytes=49826 | use_count=198
...
- software-development/verification-before-completion | source=local | status=enabled | size_bytes=20668 | use_count=251
